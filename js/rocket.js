...
var Eng = function () {
    this.canvas = document.getElementById('launchcontrol');

    this.c = document.getElementById('launchcontrol').getContext('2d');
    ...
    this.draw = function () {
        ...
        this.c.strokeStyle = 'rgba(206, 17, 65, 1)';
        this.c.lineWidth = 6;
        this.c.stroke();
        ...
        this.c.fillStyle = 'rgba(206, 17, 65, 1)';
        this.c.fill();
    }
